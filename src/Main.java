...
public class Main {
    public static void main(String[] args) {
        ...
        people = people + 94;
        totalHours = hoursPerPerson * people;
        System.out.println ("Если в компании работает " + people + " человек, то всего " + totalHours + " часов работы может быть поделено между сотрудниками");
